...
import me.zombie_striker.qualityarmory.armor.Helmet;
...
import me.zombie_striker.qualityarmory.miscitems.*;
				...
				try {
					if (f.getName().contains("yml")) {
						...
						if ((!f2.contains("invalid")) || !f2.getBoolean("invalid")) {
							...
							Ammo da = new Ammo(name, displayname, extraLore, ms, amountA, false,  price, materails,
									piercing);
