...
public class AttachmentBaseOLD implements Comparable<AttachmentBaseOLD>{
	...
	public AttachmentBaseOLD(MaterialStorage baseItem, MaterialStorage attachedItem, String newname, String newDisplayname,
			List<String> lore) {
		this.base = baseItem;
	...
	@Override
	public int compareTo(AttachmentBaseOLD arg0) {
