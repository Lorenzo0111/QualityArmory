...
public class HenryRifle extends DefaultGun {
	...
	public void reload(final Player player) {
		if (player.getItemInHand().getAmount() != getMaxBullets()) {
			...
			GunUtil.basicReload(this, player,GunType.isUnlimited(GunType.RIFLE),time);
	...
	public HenryRifle(int d,ItemStack[] ing, float damage) {
		super("HenryRifle", MaterialStorage.getMS(Main.guntype,19), GunType.RIFLE, true, AmmoType.Ammo556,  0.2,2, 9, damage,d,ing);
	}
}
